...
@reusable
@scope project-local
@description SQLAlchemy 모델의 컬럼 존재, nullable/non-nullable, server_default, UniqueConstraint, 관계 검증 패턴
@usage 신규 모델 추가 시 모델 클래스와 ARRAY_COLUMNS/NULLABLE_TEXT_COLUMNS 목록만 교체하여 재사용
@origin proj_days / agent-task1 (taste model)
@created 2026-06-02
"""
import os
