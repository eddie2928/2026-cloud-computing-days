#!/usr/bin/env bash
# Source this file to activate AgentBox HITL proxy for Claude Code.
# Usage: source ~/agentbox/scripts/activate.sh
#
# After activation, just use claude normally:
#   claude --print "your prompt"
#   claude "ask me anything"
